...
<script>
    ...
    function load_data() {
        ...
        if ($.fn.DataTable.isDataTable('#tabelLogActivity')) {
            $('#tabelLogActivity').DataTable().destroy();
        }
        ...
        $('#tabelLogActivity').DataTable({
            ...
            "lengthChange": false,
            "autoWidth": false,
            "ajax": "{{ env('APP_URL') }}/logactivity/load_data?user_id={{ request('user_id') }}&tahun=" + tahun + "&bulan=" + bulan,
    ...
    $('#tabelLogActivity tbody').on('click', 'tr', function () {
